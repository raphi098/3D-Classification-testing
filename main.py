...
if __name__ == "__main__":
    ...
    workflow = AIWorkflow(strategy)
    workflow.run_training(dataset_train, dataset_test, wandb_run_name="Pointnet", epochs=10)

    strategy = Pointnet2Strategy(num_classes=9)
    workflow = AIWorkflow(strategy)
    workflow.run_training(dataset_train, dataset_test, wandb_run_name="Pointnet2", epochs=10)
