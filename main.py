...
if __name__ == "__main__":
    path_data = os.path.join("Data_raw", "point_clouds")
    num_classes = len([folder for folder in os.listdir(path_data) if os.path.isdir(os.path.join(path_data, folder))])
    print(os.listdir(path_data))

    strategy = Pointnet2Strategy(num_classes=num_classes, num_points=1024)
