...
class Augmentation:
    ...
    def shuffle_points(self, batch_data):
    ...
    def rotate_perturbation_point_cloud_with_normal(self, batch_data, angle_sigma=0.06, angle_clip=0.18):
    ...
    def rotate_point_cloud_by_angle_with_normal(self, batch_data, rotation_angle):
        """ Rotate the point cloud along up direction with certain angle.
            Input:
